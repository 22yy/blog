...
- display 为 flex、inline-block、table-cell,、table-caption、inline-flex
...
语法：transition-timing-function: cubic-bezier(_n_,_n_,_n_,_n_);
...
Step 规定输入字段的合法数字间隔(如 step=”2”,则合法数字可为-2，0，2，4 等)
